                        ...
                        <Card key={dept.id} className="bg-white border-gray-200 shadow-lg overflow-hidden">
                            ...
                            <CardContent className="p-0">
                                <div className="p-8 text-center">
                                    <p className="text-[10px] text-[#616161] uppercase font-bold mb-2">Currently Calling</p>
                                    <div className="text-7xl font-black text-[#0d47a1] tracking-tighter mb-2 animate-in fade-in zoom-in duration-500">
                                        {activeToken ? activeToken.token_number : '---'}
                                    </div>
                                    {activeToken && (
                                        <div className="flex justify-center">
                                            <Badge className="bg-green-600/10 text-green-500 border-green-500/20 text-[10px] animate-pulse">
                                                In Progress
                                            </Badge>
                                        </div>
                                    )}
